...
public class BST
{
    ...
    public void rebalance(String outOfBalanceInitial, String outOfBalanceSecondarily)
    {
        //assuming we are out of balance left-left
        if(outOfBalanceInitial == "left" && outOfBalanceSecondarily == "left")
        {
        ...
        if(outOfBalanceInitial == "right" && outOfBalanceSecondarily == "right")
        {
            if(BSTCore.grandParent != null)
            {
            ...
            BSTCore.pivot.add(BSTCore.pivot);
        }
